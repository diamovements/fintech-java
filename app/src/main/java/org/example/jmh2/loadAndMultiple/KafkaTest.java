package org.example.jmh2.loadAndMultiple;
...
public class KafkaTest {
    ...
    public void testProducerConsumer() {
        for (Producer<String, String> producer : producers) {
            producer.send(new ProducerRecord<>(TOPIC, "key", "LOAD BALANCING + MULTIPLE CONSUMERS"), (metadata, exception) -> {
                if (exception == null) {
